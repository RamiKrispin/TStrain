...
for(l in 1:base::nrow(mape_grid)){
  ...
  rmse_grid$valid[l] <- forecast::accuracy(fc,valid)[4]
}
...
rmse_grid$avg <- (rmse_grid$period_1 + rmse_grid$period_2 + rmse_grid$period_3 +
                    rmse_grid$period_4 + rmse_grid$period_5 + rmse_grid$period_6) / periods
